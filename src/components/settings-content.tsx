...
export interface SettingsContentProps {
  /** Called after sign out (e.g. to close dialog/sheet) */
  onAfterSignOut?: () => void;
}

export function SettingsContent({ onAfterSignOut }: SettingsContentProps) {
  ...
  }, [mounted, loadStoredMic, loadStoredTtsVoice, refreshMicList]);
